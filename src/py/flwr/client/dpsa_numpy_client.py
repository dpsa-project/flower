...
# copied from src/py/flwr/numpy_client.py
#
...
class DpsaNumPyClient(ABC):
    """Abstract base class for Flower clients using NumPy with dpsa."""
    ...
    def dpsa_fit(
        self, parameters: List[np.ndarray], config: Dict[str, Scalar]
    ) -> Tuple[bool, int, Dict[str, Scalar]]:
        """Train the provided parameters using the locally held dataset.
        """
...
class DpsaNumPyClientWrapper(Client):
    ...
    def fit(self, ins: FitIns) -> FitRes:
        """Refine the provided weights using the locally held dataset. Not implemented for dpsa."""
        return None
    ...
    def dpsa_fit(self, ins: FitIns) -> DpsaFitDone:
        ...
        # Train
        results: Tuple[bool, int, Metrics] = self.numpy_client.fit(
        ...
        # Return FitRes
        success, num_examples, metrics = results
